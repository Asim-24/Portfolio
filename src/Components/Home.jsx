    ...
    <section id='Home' className=' h-150 min-w-full flex justify-center items-center'>
        ...
        <div className=' h-74 w-xl relative right-10 flex flex-col gap-4'>
           ...
           <div className=' bottom-0 w-full h-16 flex gap-4 items-center' >
            ...
            <a href="#" className='text-white p-1 text-xl text-center border-2 ml-5 border-white h-auto w-32 rounded-xl pb-2 active:bg-green-900 hover:bg-white hover:text-black transition-all duration-500 ease-in-out '>Resume</a>
